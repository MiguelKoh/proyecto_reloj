                ...
                <td align="left">
                    <table width="80%" cellpadding="1" cellspacing="1" border="0">
                        ...
                        <form action ="" method="post"> 
                            <tr>
                                <td style="text-align:center;vertical-align:middle"><h3>Reportes</h3></td>
                            </tr>   
                            <tr>
                                <td align="right">
                            ...
                            <tr><td><a href="main.php"><li><h3>Asistencia (Retardos, faltas y descuentos, horas extras) </h3></li></a></td></tr>
                            <tr><td><a href="main_horas_trabajadas.php"><li><h3>Horas laboradas del personal de Servicio Social </h3></li></a></td></tr>                        
                            <?php
                            // put your code here
                            ?>
                        </form>
