...
$pdf->AliasNbPages();
 $pdf->AddPage();
   ...
   $sente = "Select e.idEmp,e.Nombre,d.Nombre as departamento,e.idTipo, t.Descripcion as tipoEmp from empleado e INNER JOIN departamento d ON d.idDepto=e.idDepto INNER JOIN tipoempleado t ON t.idTipo=e.idTipo WHERE e.estatus is null AND e.idTipo=3 AND d.idDepto=17 ORDER BY e.idTipo, e.Nombre";
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        WHERE idEmp=".$row['idEmp']." AND idPeriodo=138";
