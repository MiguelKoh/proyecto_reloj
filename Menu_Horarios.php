                ...
                <td align="left">
                    <table width="80%" cellpadding="1" cellspacing="1" border="0">
                        ...
                        <form action ="" method="post"> 
                            <tr>
                                <td style="text-align:center;vertical-align:middle"><h3>Horarios</h3></td>
                            </tr>   
                            <tr>
                                <td align="right">
                            ...
                            <tr><td><a href="alta_horarios.php"><li><h3>Alta de horarios </h3></li></a></td></tr> 
                            <tr><td><a href="reporte_horarios.php"><li><h3>Consultar/Eliminar horarios </h3></li></a></td></tr> 
                            <?php
                            // put your code here
                            ?>
                        </form>
