...
$dbuser="sife";//"root"; // the username of your MySQL Server
$dbpass="sife"; // the password of your MySQL Server
$dbname="test"; // the name of your MySQL Database
$tblname="fechas_importantes";//"mynews"; // the name of your MySQL Database Table
$tblDateName="fechas_i";//"newsdate"; // the name of your MySQL Table Date Field
$tblContent="titulo";//"newstitle"; // the name of your MySQL Table Content Field
$tblLink="link";//"newslink"; // the name of your MySQL Table Link Field
/*
********************************************************************************
...
echo $cal->/*showYear();*/showMonth(); // this displays the month's view
?>
<br />
