<?php
	 ...
	 */
	class HorizontalBarChart_m extends BarChart {
		/**
		...
		protected function printBar() {
			...
			/*for ($j = 0; $j < $serieCount; $j++) {*/
				...
				for ($i = 0; $i < $pointCount; $i++) {
					...
					if($value<34) $color=new Color(255,0,0);
					elseif($value<67) $color=new Color(255,255,0);
					elseif($value<99) $color=new Color(0,0,255);
					else $color=new Color(0,255,0);
					/***************************************/
					imagefilledrectangle($img, $graphArea->x1 + 1, $y1, $xmax, $y2, $color->getShadowColor(0.75)->getColor($img));
