  ...
  <tr>
   ...
   <!--Comienza area de Contenido -->
      <td width="728"valign="top">
		  ...
		  <tr><td>&nbsp;</td></tr>
		  <tr>
		    <td align="center"><p class="Estilo15"> FORMULARIO DE PREINSCRIPCI�N DE NUEVO INGRESO A 2&ordm; Y 3&ordm; </p>
	        </td>
		  </tr>
		  <tr><td>&nbsp;</td></tr>
		  <tr><td><form action="Abre.php" name="Abre" method="post"><table width="100%" border="0">
		  <tr><td><div align="center"><p>Si ya cuentas con un n�mero de Folio ponlo aqui:
                &nbsp;&nbsp;<input name="MiFolio" type="text" checked="checked" onKeyPress='if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;' size="10" maxlength="4">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  ...
			  <form action="Inscribe.php" name="alta" method="post">
				<table width="100%" border="0">	 
				  <tr><td colspan="4"><div align="center">
				  	<p>Si a�n no cuentas con un n�mero de Folio llena los siguientes datos para obtenerlo:</p>
				...
				<td>
				<input name="Correo" type="text" size="30" maxlength="30"> <span class="Estilo16">*</span>				</td>
				</tr><tr><td><span class="Estilo13"> 
...
+</td>
				...
				<table width="100%" border="0">	
				<tr><td colspan="4"><div align="center">
				  <p class="Estilo13"><strong>+ </strong>Los tel�fonos van sin guiones, par�ntesis o espacios en blanco; solamente se pone el n�mero</p>
