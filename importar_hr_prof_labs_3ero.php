            ...
            <tr>
                ...
                <td align="left">
                    <table width="80%" cellpadding="1" cellspacing="1" border="0">
                        <form name="importa" method="post" enctype="multipart/form-data" action="SubirInfoCsv_hr_prof_labs_3ero.php" >
                            <tr><td style="text-align:center;vertical-align:middle"><h3>Importar horario de profesores de laboratorio de tercero </h3></td></tr>
                            <tr>
                                <td align="right">
