            ...
            <tr>
                ...
                <td align="left">
                    <table width="80%" cellpadding="1" cellspacing="1" border="0">
                        <form name="importapermisos" method="post" enctype="multipart/form-data" action="subirInfoCsvPermisos.php" >                                                        
                            <tr><td style="text-align:center;vertical-align:middle"><h3><b>Cargar Permisos </b></h3></td></tr>
                            <tr>
                            <td align="right">
                            ...
                            <tr>
                                ...
                                <input name="fechaInicio" type="text" id="fechaInicio" onClick="popUpCalendar(this, importapermisos.fechaInicio, 'dd/mm/yyyy');" size="10" value="<?php echo html_entity_decode($fechaInicio);?>"> al <input name="fechaFin" type="text" id="fechaFin" onClick="popUpCalendar(this, importapermisos.fechaFin, 'dd/mm/yyyy');" size="10" value="<?php echo html_entity_decode($fechaFin);?>">
                            ...
                            <tr><td>&nbsp;</td></tr>
                            <tr><td>Seleccione el archivo con extensi&oacute;n CSV que importar&aacute;</td></tr>                                                                                   
                            <tr><td><input type="file" name="excel" id="excel"/> </td></tr> 
                            <tr><td>&nbsp;</td></tr>                                 
                            <tr><td><input type="submit" name="enviar"  value="Importar"  onclick="validate()"/></td></tr>                            
