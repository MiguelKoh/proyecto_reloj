...
<?php
    ...
    $variables=Request("idDepto,idEmp,fechaInicio,fechaFin");
                            ...
                            <tr>
                                ...
                                <td><label>
                                       <?php 
                                              ...
                                              $SQL = "SELECT idemp, Nombre from empleado WHERE idDepto = ".$idDepto." ORDER BY Nombre,idemp";
...
<br><br>
                            ...
                            <?php
                                if(isset($_POST['buscaPermisos']) || ($fechaFin!='' AND $fechaFin!='')){
                                    //validaciones
                                ...
                                <table width='90%' cellpadding='1' cellspacing='1' border='1' align="center">
            ...
            $nombre_dia = nombre_dia ($dia_semana);
                                     ...
                                     echo "                                       
                                        <tr>
                                            ...
                                            <td align='center'><a href='eliminar_permisos.php?idPermisos=".$row['idPermisos'].
                "&fechaini=".$fechaInicio."&fechaFin=".$fechaFin."' onclick='return confirm('¿Seguro que desea BORRAR el elemento ?\n\rNo se puede deshacer')' >
