    ...
    if(isset($_POST['grabarHorarios'])){
        ...
        if ($fechaInicio > $fechaFin){
            ...
            if (trim($horaInicio) > trim($horaFin)) {
                ...
                echo "<script>location.href='reporte_horarios_empleados.php?idEmp=".$idEmp."&idCurso=".$idCurso."&idSemestre=".$idSemestre."'</script>";                               
            }        
        }
    }  
                ...
                <td >
                    <table  width="90%" cellpadding="1" cellspacing="1" border="0">
                        <form action="" name="frmPermisos" id="frmPermisos" method="post">
                            <tr >
                                <td colspan="4" style="text-align:center;"><h3><b>Alta de Horarios de Empleados </b></h3></td>
                            </tr>
                            <tr>
                                <td colspan="4" align="right">
                                     <a href='consultar_empleados.php'><img src='imagen/profes.jpg' alt='Listar Empleados' width='30' height='30' border='0' /></a>
                                    <a href='alta_horarios_empleados.php?idEmp=<?php echo $idEmp;?>'><img src='imagen/horario.gif' alt='Alta de Horarios' width='25' height='25' border='0' /></a>
                                    <a href='reporte_horarios_empleados.php?idEmp=<?php echo $idEmp;?>'><img src='imagen/buscar.gif' alt='Actualizar Horarios' width='30' height='30' border='0' /></a>
                                </td>      
                            </tr>                                                                           
