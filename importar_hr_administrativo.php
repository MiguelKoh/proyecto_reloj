<?php
    ...
    if(isset($_POST['importar'])){
        echo "<script>location.href='subirInfoCsv_hr_deportivo.php'</script>";
    }
            ...
            <tr>
                ...
                <td align="left">
                    <table width="80%" cellpadding="1" cellspacing="1" border="0">
                        <form name="importa" method="post" enctype="multipart/form-data" action="SubirInfoCsv_hr_administrativo.php" >
                            <tr><td style="text-align:center;vertical-align:middle"><h3>Importar horario de administrativos </h3></td></tr>
                            <tr>
                                <td align="right">
