                ...
                <td align="left">
                    <table width="80%" cellpadding="1" cellspacing="1" border="0">
                        <form form action="" method="post" name="Borrar_registros" >
                            <tr>
                                <td style="text-align:center;vertical-align:middle"><h3><b>Eliminar Permisos</b></h3></td>
                            </tr>   
                            <tr>
                            <td align="right">
                            ...
                            <tr><td>&nbsp;</td></tr>
                            <tr><td>Se eliminar&aacute; la informaci&oacute;n importada del reporte con extensi&oacute;n CSV de permisos</td></tr>
                            <tr><td>&nbsp;</td></tr>
                            ...
                            <?php
                                if (isset($_POST['borrar']) && !empty($_POST["fechaInicio"]) && !empty($_POST["fechaFin"])){
                                    ...
                                    //borrando registros de permisos
                                    $sente = "select  count(*) as cantidad from permisos where idperiodo = " . $id_periodo;
                                    $result = mysqli_query($cn,$sente);
                                    $row = mysqli_fetch_array($result);
                                    $cant_registros = $row['cantidad'];

                                    $sente = "DELETE FROM permisos where idperiodo = " . $id_periodo;
                                    $result = mysqli_query($cn,$sente);
                                    
                                    echo "<tr><td>Se borraron " . $cant_registros . " en tabla Permisos del periodo " . $id_periodo . "</td></tr>";
                                    
                                    echo '<script>alert ("Los permisos se borraron correctamente")</script>';
                                     }else{
