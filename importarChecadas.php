            ...
            <tr>
                ...
                <td align="left">
                    <table width="80%" cellpadding="1" cellspacing="1" border="0">
                        <form name="importa" method="post" enctype="multipart/form-data" action="subirInfoCsvChecadas.php" >
                            <tr><td style="text-align:center;vertical-align:middle"><h3><b>Cargar Bit&aacute;cora de Registros </b></h3></td></tr>
                            <tr>
                               <td align="right">
